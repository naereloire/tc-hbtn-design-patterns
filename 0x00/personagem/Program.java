public class Program {
  public static void main(String[] args) {
    ...
    try {
      Personagem magoGandalf =
          terraMediaPersonagemFactory.createPersonagem(TipoPersonagem.MAGO, "Gandalf");
    ...
    try {
      Personagem ladinoFrodo =
          terraMediaPersonagemFactory.createPersonagem(TipoPersonagem.LADRAO, "Frodo");
    ...
    try {
      Personagem guerreiroAragorn =
          terraMediaPersonagemFactory.createPersonagem(TipoPersonagem.GUERREIRO, "Aragorn");
    ...
    try {
      Personagem magaMelisandre =
          westerosPersonagemFactory.createPersonagem(TipoPersonagem.MAGO, "Melisandre");
    ...
    try {
      Personagem ladinoOberynMartell =
          westerosPersonagemFactory.createPersonagem(TipoPersonagem.LADRAO, "Oberyn Martell");
    ...
    try {
      Personagem guerreiroKhalDrogo =
          westerosPersonagemFactory.createPersonagem(TipoPersonagem.GUERREIRO, "Khal Drogo");
